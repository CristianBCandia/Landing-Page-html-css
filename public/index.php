...
<body>
    <header class="menu-content">
        ...
        <nav class="nav-header">
            <ul class="nav-list">
                <li>Início</li>
                <li>Agende sua viajem</li>
                <li>Nossos escritórios</li>
...
<footer class="footer">
    ...
    <div class="footer-top">
        <h2 class="footer-title">Horizontes</h2>
    </div>

    <div class="footer-item1">
        <h3 class="footer-subtitle">Empresa</h3>
        <ul>
            <li>Primeiro item</li>
            <li>Segundo item</li>
            <li>Terceiro item</li>
    ...
    <div class="footer-item2">
        ...
        <h3 class="footer-subtitle">Midias Sociais</h3>
        <ul>
            <li>Facebook</li>
            <li>Instagram</li>
            <li>Twitter</li>
    ...
    <div class="footer-item3">
        ...
        <h3 class="footer-subtitle">Chame no whatsapp</h3>
        <ul>
            <li>(99) 99 9-99999999</li>
        </ul>
        
        <p><span>Volte ao topo</span></p>
